    ...
    <section className="flex w-full justify-center px-4 py-10">
      <div className="w-full max-w-4xl">
        <div className="mb-8 flex items-end justify-between gap-4">
          ...
          <p className="hidden text-xs text-[#718194] sm:block">Drag nodes to model the workflow.</p>
        </div>
        ...
        <p className="mt-3 text-center text-[10px] text-[#718194] md:hidden">Swipe the canvas, then drag a node to rearrange it.</p>
      </div>
    </section>
  );
}
